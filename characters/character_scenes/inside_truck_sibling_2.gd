...
func _start_dialogue() -> void:
	...
	print("Starting dialogue: sibling_chick_2_random1" + dialogue_line)
	var dialog = Dialogic.start("sibling_chick_2_random1")
...
func DialogicSignal(arg: String) -> void:
	if arg == "exit_sibling2":
		print("signal received")
		InsideTruckGlobal.sibling2_exit = true
...
func _on_chat_detection_body_entered(body):
	if body.has_method("player"):
		...
		if InsideTruckGlobal.sibling2_exit == false:
